...
$(document).ready(function () {
 /* ====================================
  ...
  $.backstretch([
    // 'assets/img/4.jpg', // change image url here
    // 'assets/img/5.jpg',
    // 'assets/img/6.jpg',
    'assets/img/7.jpg'
    // 'assets/img/8.jpg',
    // 'assets/img/9.jpg',
    // 'assets/img/10.jpg'
  ], { duration: 3000, fade: 'slow' }) // duration is in milliseconds
  ...
  setInterval(function () {
    var enddate = new Date('Nov 27 2017 00:00:00 GMT+07:00') // change your date here like Jan 10 2016 GMT+05:00
  ...
  function GlobalFunctn (valuesmy) {
    if (valuesmy < 0) { valuesmy = 0 }

    if (valuesmy < 10) { return '0' + valuesmy }
